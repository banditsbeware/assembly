...
extern uint64_t add32		(uint32_t x, uint32_t y); //
extern uint64_t sub64		(uint64_t x, uint64_t y);
extern uint16_t minU16		(uint16_t x, uint16_t y);
extern int32_t  minS32		(int32_t x, int32_t y);
extern bool 	isLessThanU16	(uint16_t x, uint16_t y); 
extern bool	isLessThanS16	(int16_t x, int16_t y); 
extern uint16_t shiftLeftU16 	(uint16_t x, uint16_t p); 
extern uint32_t shiftU32	(uint32_t x, int32_t p); 
extern int8_t   shiftS8		(int8_t x, int8_t p);  
extern bool 	isEqualU32	(uint32_t x, uint32_t y); 
